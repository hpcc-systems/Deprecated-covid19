...
export default class ListService {
    ...
    private lists = [{moduleId:'us_states', id:'us_states/map', title: 'Map', description: 'Investigate trends and view models as to how each state is progressing',isDefault: true},
                     ...
                     {moduleId:'us_counties', id:'us_counties/counties_metrics', title: 'Weekly Metrics', description: 'Weekly snapshot of metrics for US Counties. Please use the filters to select the states and period.',isDefault: false},
