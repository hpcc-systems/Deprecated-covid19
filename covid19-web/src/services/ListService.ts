...
export default class ListService {
    ...
    private lists = [{moduleId:'us_states', id:'us_states/map', title: 'Map', description: 'Investigate trends and view models as to how each state is progressing',isDefault: true},
                     {moduleId:'us_states', id:'us_states/trends', title: 'Daily Trends - States', description: `Daily snapshot of cases and deaths for US states as of ${new Date()}. Please use the filters to select the states.`,  isDefault:false},
                     ...
                     {moduleId: 'world_countries', id: 'world_countries/trends', title: 'Daily Trends', description: `Daily snapshot of cases and deaths by countries as of ${new Date()}. Please use the filters to select the countries.`, isDefault: false},
                     ...
                     {moduleId:'us_counties', id:'us_counties/trends', title: 'Daily Trends - US Counties', description: `Daily snapshot of cases and deaths for US Counties as of ${new Date()}. Please use the filters to select the counties.`,  isDefault:false},
                     {moduleId:'us_counties', id:'us_counties/counties_metrics', title: 'Metrics - Counties (SIR Model)', description: 'Weekly snapshot of metrics for US Counties. Please use the filters to select the states and period.',isDefault: false},
