...
export default class ListService {
    ...
    private lists = [{moduleId:'us_states', id:'us_states/summary', title: 'Summary', description: 'Daily snapshot of cases and deaths for US states. Please use the filters to select the states.',  isDefault:true},
                     ...
                     {moduleId: 'world_countries', id: 'world_countries/summary', title: 'Summary', description: 'Daily snapshot of cases and deaths by countries. Please use the filters to select the countries.', isDefault: true},
                     ...
                     {moduleId:'us_counties', id:'us_counties/counties_metrics', title: 'Metrics', description: 'Daily snapshot of metrics for US Counties. Please use the filters to select the states and period.',isDefault: true},
                    ];//Inline Data
