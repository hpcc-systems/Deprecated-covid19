...
export default class Catalog {
  static initMaps() {
    ...
    maps.set('THE WORLD-US-ALASKA', { file: 'us-counties-alaska.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 63, long: -150.0, zoom: 4.5, });
    ...
    maps.set('THE WORLD-US-ARKANSAS', { file: 'us-counties-arkansas.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 35.146, long: -92.33, zoom: 7.5, });
    maps.set('THE WORLD-US-CONNECTICUT', { file: 'us-counties-connecticut.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 41.0, long: -72.492, zoom: 8.5, });
    ...
    maps.set('THE WORLD-US-IDAHO', { file: 'us-counties-idaho.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 44.0, long: -114.0, zoom: 7.5, });
    ...
    maps.set('THE WORLD-US-ILLINOIS', { file: 'us-counties-illinois.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 40.507, long: -89.513, zoom: 7.5, });
    maps.set('THE WORLD-US-INDIANA', { file: 'us-counties-indiana.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 39.3016, long: -86.475, zoom: 8.0, });
    maps.set('THE WORLD-US-IOWA', { file: 'us-counties-iowa.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 42.383, long: -93.2404, zoom: 7.5, });
    maps.set('THE WORLD-US-KANSAS', { file: 'us-counties-kansas.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 38.4789, long: -98.756, zoom: 7.5, });
    maps.set('THE WORLD-US-KENTUCKY', { file: 'us-counties-kentucky.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 37.5, long: -85.5, zoom: 8.0, });
    ...
    maps.set('THE WORLD-US-VIRGINIA', { file: 'us-counties-virginia.geojson', secondaryFile: '', colorKeyField: 'geoid', selectKeyField: 'name', lat: 37.5722077541, long: -78.6149783508, zoom: 7.5, });
